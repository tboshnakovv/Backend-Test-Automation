...
namespace TestGitHubApi
{
    public class TestGitHubApi
    {
        ...
        public void Setup()
        {            
            client = new GitHubApiClient("https://api.github.com/repos/testnakov/", "tboshnakovv", "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");
        ...
        public void Test_GetAllIssuesFromARepo()
        {
            ...
            //Act
            //Момента, в който се изпълнява заявката
            var issues = client.GetAllIssues(repo);

            // Assert
            Assert.That(issues, Has.Count.GreaterThan(1), "Issue ID should be greater than one issue");
        ...
        public void Test_GetAllCommentsForIssue()
        {
            ...
            // Assert
            Assert.That(comments.Count, Is.GreaterThan(0), "There should be comment on the issue");
        ...
        {
            // Arrange
            int commendId = lastCreatedCommentId;
            

            //Act
            var comment = client.GetCommentById(repo, commendId);


            // Assert
            Assert.That(comment, Is.Not.Null);
            Assert.That(commendId, Is.EqualTo(commendId));
        ...
        public void Test_EditCommentOnGitHubIssue()
        {
            ...
            //Act
            var updatedComment = client.EditCommentOnGitHubIssue(repo, commendId, newBody);


            // Assert
            Assert.That(updatedComment, Is.Not.Null);
            Assert.That(updatedComment.Id, Is.EqualTo(commendId));
        ...
        public void Test_DeleteCommentOnGitHubIssue()
        {
            ...
            //Act
            var result = client.DeleteCommentOnGitHubIssue(repo, commendId);
