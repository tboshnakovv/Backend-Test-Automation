...
namespace RestSharpServices
{
    public class GitHubApiClient
    {
        ...
        {
            //По подразбиране когато няма зададен метод(заявка) е GET
        ...
        {
            var request = new RestRequest($"{repo}/issues");
            //задължителните елементи на едно issue са title, body  и номер но номера се генерира автоматично.
            // Тялото на request-a трябва да бъде Json
